...
const oldStr = `          proseContainer.innerHTML = articleHeaderHtml + parseSimpleMarkdown(rawMd);
...
const newStr = `          if (window.resetToc) window.resetToc();
...
console.log("Updated loadArticle in index.html");
